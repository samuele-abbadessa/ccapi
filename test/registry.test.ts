...
describe("Repository", () => {
  ...
  it("listSessions ordina per updated_at DESC (più recenti attive prima)", () => {
    const a = repo.createSession("A", null, null, 1000);
    const b = repo.createSession("B", null, null, 2000);
